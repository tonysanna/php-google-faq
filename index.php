...
<body>
    ...
    <div class="wrapper">
        <?php
            foreach($faq as $domandaData) {
                echo'<h1>'. $domandaData['domanda'] .'</h1>';
                echo $domandaData['risposta'];
            }
        ?>
    </div>
    </section>
